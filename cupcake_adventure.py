...
class Game(arcade.Window):
    def __init__(self):
        ...
        # Load sounds
        self.collect_coin_sound = arcade.load_sound("sounds/set_1/coin1.wav")
        self.jump_sound = arcade.load_sound("sounds/set_1/jump1.wav")
        self.game_over = arcade.load_sound("sounds/set_1/gameover1.wav")
    ...
    def setup(self, level):
        ...
        self.player_sprite = arcade.Sprite(
            "images/player/stand/0.png", CHARACTER_SCALING)
        ...
        # -- Background
        self.background_list = arcade.generate_sprites(
            my_map, background_layer_name, TILE_SCALING)

        # -- Foreground
        self.foreground_list = arcade.generate_sprites(
        ...
        # -- Coins
        self.coin_list = arcade.generate_sprites(
            my_map, coins_layer_name, TILE_SCALING)

        # -- Don't Touch Layer
        self.dont_touch_list = arcade.generate_sprites(
